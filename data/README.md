...
## Where the official label manifests live

The R03–R09 official-label overlay and the R10/R11 audit manifests live under `docs/data_and_evidence/qualifying/official_labels/` — that path is part of the frozen scoring contract (`official_labels.py` reads it directly), so they are not moved into `data/`. They are inputs to scoring, and are listed here for completeness.
