...
Ask anyone who follows the sport what goes into a qualifying result, and the answers arrange themselves into a short list. A driver on a run of strong Saturdays is likely to keep going — recent form. The car underneath him matters as much as the driver — constructor strength. Some circuits suit some cars and some drivers — circuit history at the same track. Between the sessions, paddock reporting on setup choices and upgrade feedback moves expectations — pre-race evidence. And a driver who has been retiring frequently is a poor bet for a clean lap — reliability. One more sits slightly apart: not a factor in the result so much as a property of the track — its character (high downforce or street, for instance) — which plausibly changes how much the other factors are worth.
