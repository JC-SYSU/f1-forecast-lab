...
**The post-freeze stretch: three wins, one correction.** The three rounds after the weight freeze (6.8) went 0.6155 / 0.5864 / 0.5322 against the baseline's 0.4614 / 0.4464 / 0.4928 — a three-round mean of 0.5780 vs 0.4669, three wins in three, with uneven margins (+0.15, +0.14, +0.04). The largest margin has a concrete origin: at Monza, Antonelli was penalized to the back of the grid for a full power-unit change — the baseline had no place for the driver in its top ten, while the model ranked Antonelli P1 — and Antonelli won that race. The design assumption that "strong teams at the back will recover" (6.7) played out at Monza in its most extreme form.
